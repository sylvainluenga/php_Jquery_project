...
<div class="art-content-layout">
  ...
  <table  align="center"width="283%" height="50">
    ...
    <tr bgcolor="#ffff00">
      ...
      <td  align="center"width="92"><div align="center"><span class="style14 style5"><strong>Amount </strong></span></div></td>
	       <td  align="center"width="87"><div align="center"><span class="style14 style5"><strong>Date</strong></span></div></td>
    </tr>
    <?php 
	$qry=mysql_query("select * from pymnts order by date") or die(mysql_error());
    ...
    <tr bgcolor="#CCCCCC">
	  ...
	  <td  bgcolor="#99FFFF"align="center"><div align="center"><span class="style8"><strong><?php echo $rw['amount']; ?></strong></span></div></td>
