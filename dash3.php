...
<nav class="art-nav">
    <div class="art-nav-inner">
	 ...
	 <ul class="art-hmenu"><li><a href="Logout.php" class="active">Exit</a></li></ul> 
	   <ul class="art-hmenu"><li><a href="changepas.php" class="active">PAssword</a></li></ul> 
	   <ul class="art-hmenu"><li><a href="backup.php" class="active">Backup</a></li></ul> 
	   <ul class="art-hmenu"><li><a href="rs.php" class="active">Results</a></li></ul> 
	   <ul class="art-hmenu"><li><a href="owings.php" class="active">Owings</a></li></ul> 
