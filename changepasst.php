...
$qry=mysql_query("select * from students where fullname='$_SESSION[fullname]' and password='$oldpass'") or die(mysql_error());
$count=mysql_num_rows($qry);
	...
	$qy=mysql_query("update students set password='$newpass' where fullname='$_SESSION[fullname]'") or die(mysql_error());
			if($qy)					
					{
					message_goto('Password successfully changed','dash1.php');
					}
