...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.1.0.59861 -->
    <meta charset="utf-8">
<title>Student SystemLogIn</title>
    ...
    <div class="art-layout-cell layout-item-1" style="width: 34%" >
        ...
        <form name="form1" method="post" action="">
          <table width="434" border="0">
            <tr>
              <th colspan="2" scope="row">Student Log In </th>
              </tr>
            <tr>
...
@$pass=$_POST['password'];
 if(isset($_POST['Submit']))
 {
			...
			$query=mysql_query("select * from students where studentid='$user' and password='$pass' and status='1'") or die(mysql_error());
			$count=mysql_num_rows($query);
				if($count==0)
					{
				alert("Either your username or password is incorrect! Please try again OR Contact The System Admin");
					}
		
			
			$qr=mysql_query("select * from students where studentid='$user' and password='$pass'") or die(mysql_error());
